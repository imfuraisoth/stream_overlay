...
window.I18N.ja = {
      ...
      st_refresh: "更新",
      st_popout: "⧉ ポップアウト",
      st_announcement_ph: "ステーション一覧の上に表示するお知らせ（例：スコアは受付までご報告ください）",
      st_announcement_saved: "保存しました",
      ...
      pl_country: "国",
      pl_state: "州 / 地域",
      pl_state_ph: "例：TX（シードチェック用。配信には表示されません）",
      pl_city: "都市",
      pl_city_ph: "例：Dallas（将来のシードチェック用。配信には表示されません）",
      pl_social: "SNS",
      ...
      sd_rematch_rounds: "再戦を警告する範囲",
      sd_rematch_off: "オフ",
      sd_rematch_r1: "1回戦",
      sd_rematch_r2: "最初の2回戦",
      sd_rematch_r3: "最初の3回戦",
      sd_rematch_recency: "再戦の新しさ",
      sd_rematch_lookback: "直近N大会のみ（0=すべて）",
      sd_rematch_title: "早期再戦の可能性",
      sd_rematch_sub: "これらのシード選手は過去に対戦しており、標準（両端）配置では早い段階で当たります。避けたい場合はシードを離してください。",
      sd_rematch_col_round: "ラウンド",
      sd_rematch_col_players: "選手",
      sd_rematch_col_last: "前回の対戦",
      sd_rematch_latest: "直近の大会",
      sd_rematch_ago: "大会前",
      sd_check_mode: "ブラケットチェック",
      sd_check_off: "オフ",
      sd_check_rematch: "再戦のみ",
      sd_check_state: "同一州のみ",
      sd_check_both: "両方",
      sd_check_city: "同一都市のみ",
      sd_check_all: "すべてのチェック",
      sd_check_rematch_state: "再戦 + 州",
      sd_check_rematch_city: "再戦 + 都市",
      sd_state_title: "同一州の早期対戦の可能性",
      sd_state_sub: "これらのシード選手は同じ州・地域の出身で、早い段階で当たります。地域が偏らないようにしたい場合は離してください。",
      sd_state_col: "州",
      sd_city_title: "同一都市の早期対戦の可能性",
      sd_city_sub: "これらのシード選手は同じ都市—または同じ都市圏—の出身で、早い段階で当たります。州が偏る大会ではこちらがより有効な地元シグナルです。",
      sd_city_col: "都市",
      sd_city_metro: "都市圏",
      sd_city_metro_tip: "都市名は異なるが同じ都市圏",
      sd_pull_loc: "start.ggから所在地を取得",
      sd_need_slug: "先にトーナメント/イベントを入力してください。",
      sd_loc_pulling: "start.ggから所在地を取得中...",
      sd_loc_review_title: "start.ggの選手所在地を確認",
      sd_loc_summary: "確認対象の所在地",
      sd_loc_flagged: "要確認",
      sd_loc_nothing: "更新なし -- 一致した選手はすでに所在地データが揃っています。",
      sd_loc_none_returned: "start.ggからこれらの選手の所在地データは返されませんでした。",
      sd_loc_inferred: "推定",
      sd_loc_inferred_tip: "米国の州から推定",
      sd_loc_col_player: "選手",
      sd_loc_col_current: "現在",
      sd_loc_col_sgg: "start.gg",
      sd_loc_col_save: "保存内容",
      sd_loc_conflict: "不一致",
      sd_loc_nonstd: "非標準",
      sd_loc_fill: "新規",
      sd_loc_unmatched: "未マッチ",
      sd_loc_create: "プロフィール作成",
      sd_loc_cancel: "キャンセル",
      sd_loc_apply: "選択を保存",
      sd_loc_created: "プロフィールを作成しました:",
      sd_loc_saved: "所在地を保存しました:",
      sd_loc_players: "人",
      sd_drag_hint: "行をドラッグしてシードを並べ替え -- 再戦チェックはその場で更新されます。",
      sd_reset_order: "推奨順にリセット",
      sd_add_all_nohist: "未シードを全員追加",
      sd_added_nohist: "名をシードリストの末尾に追加しました。",
      sd_pool_count: "プール",
      sd_pools_hint: "プールは完全に手動です -- 全体順位から下のプールへ選手をドラッグしてください。再戦・州・都市チェックは各プール内で独立して実行され、プール間で比較されることはありません。",
      sd_pool_label: "プール",
      sd_pool_empty: "ここに選手をドラッグ",
      sd_overall_ranking: "全体順位",
      sd_drag_hint_pools: "選手を下のプールへドラッグしてください。",
      sd_reset_pools: "全プールを空にする",
      sd_unassigned: "未割当",
      sd_col_assign: "割り当て",
      sd_move_to_pool: "プールへ移動",
      sd_move_to_staging: "全体順位へ戻す",
      sd_save_order: "並び順を保存",
      sd_order_saved: "このイベントのシード順を保存しました -- 再計算後も復元されます。",
      sd_order_restored: "保存したシード順を復元しました",
      sd_drag_in_hint: "プレイヤーをシード順に上へドラッグして配置します。",
      sd_no_history: "履歴なし",
      sd_return: "元のセクションに戻す",
      sd_ranked: "シード順の提案",
      ...
      // data backup page  -- FLAG: review backup/transfer terms
      bk_title: "データバックアップ — ストリームオーバーレイ",
      bk_heading: "データのバックアップと移行",
      bk_hint: "プレイヤーデータベースと対戦履歴を1つのファイルにエクスポートし、別のコンピューターでインポートできます。1台で準備して会場のノートPCに持ち込めます。",
      bk_export_title: "エクスポート",
      bk_export_sub: "選択したデータのJSONバンドルをダウンロードします。",
      bk_players: "プレイヤーデータベース",
      bk_history: "対戦履歴",
      bk_export_btn: "バンドルをダウンロード",
      bk_import_title: "インポート",
      bk_import_sub: "別のマシンからバンドルを読み込みます。置き換えまたは統合でき、先に自動バックアップが作成されます。",
      bk_soon: "近日公開",
      bk_pick_one: "エクスポートする項目を1つ以上選択してください。",
      bk_exporting: "ダウンロードを準備中…",
      bk_export_done: "バンドルをダウンロードしました。",
      bk_import_btn: "インポート（置き換え）",
      bk_mode_replace: "置き換え",
      bk_mode_merge: "統合",
      bk_replace_note: "「置き換え」は、選択したデータをこのマシン上でバンドルの内容に上書きします。先に現在のデータがバックアップされます。",
      bk_reading: "ファイルを読み込み中…",
      bk_bad_json: "そのファイルは有効なJSONではありません。",
      bk_bundle_contains: "このバンドルの内容：",
      bk_players_lc: "人のプレイヤー",
      bk_events_lc: "件のイベント",
      bk_exported: "エクスポート日時",
      bk_choose_file: "先にバンドルファイルを選択してください。",
      bk_confirm_prompt: "「置き換え」は選択したデータをこのマシン上で上書きします（先にバックアップされます）。確認するには REPLACE と入力してください。",
      bk_cancelled: "インポートをキャンセルしました。",
      bk_importing: "バックアップとインポート中…",
      bk_import_done: "インポートしました。",
      bk_backup_saved: "以前のデータのバックアップ先：",
      bk_merge_btn: "インポート（統合）",
      bk_merge_note: "「統合」はバンドルを既存のデータに結合します。自動的に照合できないプレイヤーについては確認が求められます。先に現在のデータがバックアップされます。",
      bk_analyzing: "分析中…",
      bk_resolve_title: "いくつかのプレイヤーは判断が必要です",
      bk_auto_merged: "自動照合",
      bk_auto_new: "新規",
      bk_import_as_new: "新規プレイヤーとしてインポート",
      bk_merge_into: "統合先：",
      bk_apply_merge: "統合を実行",
      bk_merged_lc: "件統合",
      bk_added_lc: "件追加",
};